...
public class InventoryTest {
    static final Logger logger = Logger.getLogger(InventoryTest.class.getName());
...
//        driver = new ChromeDriver();
    ...
    @Test(description = "Add all items to cart",
            timeOut = 6000,
            groups = "saucedemo")
    public void sauceTest() throws InterruptedException {
        ...
        logger.info("Number of products: " + inventoryPage.inventoryItemsCount());
        inventoryPage.clickToAddButtons();
        int expectedNumber = 6;
        logger.info("ExpectedNumber: " + expectedNumber);
        int actualNumber = inventoryPage.productsInCart();
